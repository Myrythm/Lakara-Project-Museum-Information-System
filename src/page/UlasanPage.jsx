        ...
        <Row className="aligh-items-left">
          <Col xs={12} md={6} xl={7}>
              ...
              <div className='overlap-2'>
                  ...
                  <p style={{ fontSize: '14px'}}>Museum Nasional Republik Indonesia, yang dikenal juga sebagai Museum Gajah, 
          ...
          masa prasejarah hingga masa kini. Berlokasi di Jakarta Pusat, museum ini menjadi destinasi wisata edukasi yang menarik untuk mempelajari sejarah dan budaya Indonesia. </p>
          ...
          <Col xs={12} md={6} xl={5}>
                <div >
                  <img src={gambar1} alt="museum21" className="gambar"/>
                </div>
          </Col>
        </Row>
      </Container>
