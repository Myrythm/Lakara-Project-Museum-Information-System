            ...
            <Navbar expand="lg" className="nav">
                <Container>
                    ...
                    <Nav className="ms-auto text-center">
                        ...
                        <Nav.Link href="#home" className='mx-2 text-white'>Beranda</Nav.Link>
                        <Nav.Link href="#link" className='mx-2 text-white'>Tentang</Nav.Link>
                        <Nav.Link href="#link" className='mx-2 text-white'>Kontak</Nav.Link>
